...
class HistoryClickScreen extends StatefulWidget {
  ...
  const HistoryClickScreen({Key? key, required this.categoryName}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // 내용 (정치/경제/이슈 등 모두 동일 레이아웃, 상단 타이틀만 다르게)
              Expanded(
                child: Padding(
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.category, size: 32, color: Color(0xFF0565FF)),
                          ),
